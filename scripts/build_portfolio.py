...
add(p('NVIDIA KOREA AGENTIC AI HACKATHON 2026','sub'),Spacer(1,32),p('SkillForge','title'),p('정책이 바뀌면,<br/>자동화의 근거도 다시 검증합니다.','h'),p('에이전트의 실행 경험을 재사용 가능한 절차로 바꾸고,<br/>변경 영향을 확인한 뒤 검증된 버전만 다시 활성화합니다.'),Spacer(1,26),table([['실행 경험','변경 영향','운영 판단'],['출처 기반 6단계 절차','정책 전후 42쌍 비교','재검증 후 명시적 활성화']],[158,158,159]),Spacer(1,22),p('팀 TraceMakers','sub'),p(link(repo,'GitHub: github.com/kkokkiyo/skillforge')),p(link(repo+'/blob/main/output/video/SkillForge-evidence-walkthrough.mp4','3분 데모 영상 - 저장된 실행 증거의 시각화')),p('2026-09-26 / 합성 커머스 전액 환불 데모','small'),p('실제 고객정보·결제 없음. 팀 TraceMakers의 대표 프로젝트입니다. 주최측 Skill API 세부 요구의 충족 여부는 답변 대기 중입니다.','small'),PageBreak())
